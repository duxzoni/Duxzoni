...
public class ListasDeComprasView extends JDialog {
	...
	public ListasDeComprasView(MyPrevaylerPersistence myPersistence) {
		...
		listas = new JList();
		JScrollPane histScroll = new JScrollPane(listas);
	...
	private void preencheLista() {
		...
		List<ListaDeCompras> listasDeCompras = myPersistence.getListasDeCompras(de, ate);
		Collections.sort(listasDeCompras);

		DefaultListModel listModel = new DefaultListModel();
		for (ListaDeCompras historicoEstoque : listasDeCompras)
...
//		HistoricoEstoque historicoEstoque = (HistoricoEstoque)listas.getSelectedValue();
//		EstoqueView estoque = new EstoqueView(myPersistence, historicoEstoque.getEstoque(), DateManager.ddmmaaaaMMssSeparated(historicoEstoque.getData()));
